...
const filterdata1 = myCoding.filter((cod)=>{cod.languageName === "java"})
console.log(filterdata1)//return:-
/*[]*/

const filterdata2 = myCoding.filter((cod)=>{return cod.languageName === "java"})
...
const filterdata3 = myCoding.filter((cod)=>{return cod.languageName === "python" && cod.languageFileName === "py"})
